...
SD Card for EV3 Brick: Micro SDHC (min. 4GB, max. 32GB) with Application Performance Class A1
  ...
  * [pybricks github.io documentation](https://pybricks.github.io/ev3-micropython/index.html)
  * [pybricks.com documentation](https://docs.pybricks.com/en/latest/index.html)
